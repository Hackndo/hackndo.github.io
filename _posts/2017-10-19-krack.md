...
J'ai [commencé un PoC de l'attaque](https://github.com/Hackndo/krack-poc) sur Github qui marche de temps en temps mais qui reste très instable. Si vous vous sentez de le regarder, le comprendre, et l'améliorer, n'hésitez pas !
...
**[Edit 22/10/2017]** J'ai finalement trouvé la réponse à ma question : Il faut utiliser la technique dite du *channel-based Man-in-the-Middle* décrite dans [Advanced Wi-Fi Attacks Using Commodity Hardware](https://distrinet.cs.kuleuven.be/news/2015/AdvancedWiFiAttacksUsingCommodityHardware.pdf) **[/edit]**

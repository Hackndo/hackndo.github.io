...
Dans cet exemple, F est une fonction complexe, et si `paramètre_1` et `paramètre_2` sont différents, nous ne pourrons pas retrouver le message clair facilement. En revanche, s'ils sont similaires, alors nous aurons :

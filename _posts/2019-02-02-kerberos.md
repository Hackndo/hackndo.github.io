...
C'est un processus relativement complexe, mais une fois que les étapes ont été vues en détails, on comprend mieux l'utilisté de chacunes d'elles. Voici un schéma récapitulatif des trois étapes pour un client qui demande un accès à deux services différents (cliquez sur l'image si vous voulez l'agrandir) :

[![Kerberos](/assets/uploads/2019/02/kerberos_resume.png)](/assets/uploads/2019/02/servicecheck.png)
